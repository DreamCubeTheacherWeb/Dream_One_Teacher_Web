...
import {
    ...
    ContactRound, BookOpen, GraduationCap, Settings, Shield, FileSignature, Wallet, Download, Award, Layers3, FileSpreadsheet
} from 'lucide-react';
        ...
        <div className="p-4 sm:p-8">
            ...
            <div className="mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {isAdmin && <NavCard to="/admin/salary/export" icon={FileSpreadsheet} title="報酬供應商 CSV" desc="依老師、日期區間或等級匯出財務供應商格式" color="blue" />}
