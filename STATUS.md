...
> 最後更新：2026-08-15（畫布多行縮排與字級選取跳動已在本機修正並完成真瀏覽器驗證）。

---

## 🔤 2026-08-15：畫布多行縮排與字級選取穩定性（✅ 本機完成；⏳ 尚未部署）
...
只回報兩個本次未新增的既有底部面板 `border-t-2` 警告。

**正式環境邊界**：未修改正式 Supabase、未 push／部署，不需 SQL migration。
