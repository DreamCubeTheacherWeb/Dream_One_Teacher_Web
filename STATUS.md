...
> 最後更新：2026-08-14（畫布框選與暫時多選操作已完成本機驗證，正在部署）。

---

## 🖱️ 2026-08-14：畫布框選與暫時多選（✅ 本機完成；⏳ 部署中）
...
**正式環境邊界**：未修改正式 Supabase；正準備推送至 `main` 並由 Zeabur 部署。鎖定欄位沿用既有
`contents.position_data` JSON，不需 SQL migration。
